...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(GET,   "/api/v1/reactions/{graveId}").access("@AccessBeans.hasGraveAccessOrIsAdmin( #graveId )")
                .antMatchers(POST,  "/api/v1/reactions/{graveId}").access("@AccessBeans.hasAtLeastWriteAccess( #graveId )")
                .antMatchers(PUT,   "/api/v1/reactions/{graveId}/{reactionId}").access("@AccessBeans.isGraveOwnerOrAuthor( #graveId, #reactionId )")
                .antMatchers(DELETE,"/api/v1/reactions/{graveId}/{reactionId}").access("@AccessBeans.isGraveOwnerOrAuthor( #graveId, #reactionId )")
