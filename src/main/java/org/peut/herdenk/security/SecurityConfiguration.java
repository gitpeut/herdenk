...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(GET,   "/api/v1/graves/summary/{graveId}").permitAll()
                ...
                .antMatchers(GET,   "/api/v1/authorities/user/{userId}/grave/{graveId}").access("@AccessBeans.hasAtLeastOwnerAccess( #graveId )")
